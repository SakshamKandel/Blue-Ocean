...
export default function Portfolio() {
  ...
  return (
    <div className="min-h-screen bg-surface-lowest selection:bg-secondary/20 font-sans relative">
      ...
      <section className="py-20 md:py-28 px-4 sm:px-6 bg-surface-lowest relative z-20 overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-80px" }} variants={staggerContainer}>
            ...
            <motion.h2 variants={fadeInUp} className="font-display text-4xl md:text-6xl font-bold tracking-tight text-primary mb-10 md:mb-16 leading-tight">
              Public Equities & <br/>Listed Growth
            </motion.h2>
          </motion.div>

          {/* Featured Fund */}
          <motion.div initial={{ opacity: 0, y: 40, scale: 0.98 }} whileInView={{ opacity: 1, y: 0, scale: 1 }} viewport={{ once: true, margin: "-80px" }} transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }} className="p-6 sm:p-10 bg-primary rounded-3xl text-white mb-12">
          ...
          <div className="space-y-8">
            {[
              ...
              <motion.div key={item.label} initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="group">
                <div className="flex flex-col gap-1 sm:flex-row sm:justify-between sm:items-end mb-2">
      ...
      {/* ═══════════════════════ PROMOTER BENEFITS ═══════════════════════ */}
      <section className="py-20 md:py-28 px-4 sm:px-6 bg-primary text-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto relative z-10">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
            ...
            <div className="relative">
              <div className="p-6 sm:p-10 md:p-12 bg-white/5 backdrop-blur-xl rounded-[2rem] md:rounded-[40px] border border-white/10">
      ...
      <section className="py-20 md:py-28 px-4 sm:px-6 bg-surface">
        <div className="max-w-7xl mx-auto">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer}>
            ...
            <motion.p variants={fadeInUp} className="text-on-surface-variant text-lg sm:text-xl leading-relaxed max-w-2xl mb-12 md:mb-16 opacity-70">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="grid md:grid-cols-2 gap-8">
            <motion.div variants={fadeInUp} className="p-6 sm:p-10 bg-surface-lowest rounded-3xl border border-outline-variant/10 group hover:-translate-y-2 transition-transform duration-500">
