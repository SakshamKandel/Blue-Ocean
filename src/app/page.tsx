...
export default function Home() {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-surface-lowest selection:bg-secondary/20 font-sans relative">
      ...
      <section className="py-16 md:py-24 px-4 sm:px-6 bg-surface-lowest relative border-b border-outline-variant/5 overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              <motion.h2 variants={fadeInUp} className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-primary tracking-tighter leading-[0.9] md:leading-[0.85] mb-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-8 sm:gap-y-12 gap-x-8 sm:gap-x-12">
                {[
                  ...
                  <motion.div key={i} variants={fadeInUp} className="border-l-[2px] border-primary/10 pl-6 sm:pl-8 group">
            ...
            <motion.div 
               ...
               className="relative aspect-[4/5] md:aspect-square lg:aspect-[4/5] rounded-[2rem] md:rounded-[3rem] overflow-hidden shadow-2xl shadow-primary/5 border border-outline-variant/10 group"
            >
              ...
              <div className="absolute inset-4 sm:inset-8 p-4 sm:p-10 flex flex-col justify-end">
                <div className="p-5 sm:p-6 bg-white/10 backdrop-blur-2xl rounded-2xl sm:rounded-3xl border border-white/20 shadow-2xl">
      ...
      <section className="py-20 md:py-28 bg-primary text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
           <div className="mb-16 md:mb-24 max-w-5xl mx-auto text-center">
              <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} className="flex justify-center items-center gap-4 sm:gap-6 mb-10">
                <div className="w-8 sm:w-12 h-[1px] bg-secondary-fixed-dim/20" />
              ...
              <motion.h2 
                ...
                className="font-display text-4xl sm:text-5xl md:text-8xl font-black tracking-tighter leading-[0.9] md:leading-[0.85] text-white mb-10 md:mb-12"
              >
           ...
           <div className="grid md:grid-cols-2 gap-8 md:gap-12 max-w-5xl mx-auto mb-20 content-center justify-center">
             <div className="p-6 sm:p-10 rounded-[2rem] md:rounded-[2.5rem] bg-white/5 border border-white/10 hover:border-secondary/30 transition-all duration-700">
      ...
      {/* ═══════════════════════ FINAL CALL ═══════════════════════ */}
      <section className="py-16 md:py-24 px-4 sm:px-6 bg-surface-lowest text-center relative overflow-hidden">
        <div className="absolute inset-0 bg-grid-theme opacity-[0.05] pointer-events-none" />
        <motion.div 
           initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer}
           className="max-w-4xl mx-auto relative z-10"
        >
          <motion.h2 variants={fadeInUp} className="font-display text-4xl sm:text-5xl md:text-8xl font-black text-primary tracking-tighter leading-none mb-8">
          ...
          <motion.div variants={fadeInUp}>
            <Link href="/contact" className="inline-flex w-full sm:w-auto items-center justify-center gap-4 px-8 sm:px-12 py-6 bg-primary text-white rounded-2xl font-bold text-[10px] tracking-[0.2em] sm:tracking-[0.3em] uppercase hover:bg-secondary transition-all group shadow-2xl shadow-primary/20 hover:scale-105 active:scale-95">
