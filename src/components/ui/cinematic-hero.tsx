...
const INJECTED_STYLES = `
  ...
  /* INSIDE THE CARD: Institutional Silver/White */
  ...
  .premium-depth-card {
      background: linear-gradient(145deg, #00103e 0%, #00081a 100%);
      box-shadow: 
...
export function CinematicHero({ 
  ...
  tagline1 = "Forensic Precision.",
  tagline2 = "Sustainable Alpha.",
  cardHeading = "Chartered Accountant–Led Investment Firm.",
  cardDescription = <><span className="text-white font-semibold">Blue Ocean Inco</span> identifies market inefficiencies with forensic precision, using institutional-grade scrutiny to safeguard capital and capture sustainable alpha.</>,
  metricValue = 15.0,
  metricLabel = "Target Alpha %",
  ctaHeading = "Ready to invest with precision?",
  ctaDescription = "Join an elite cohort of investors benefiting from CA-led governance and strategic market vision.",
  className, 
  ...props 
}: CinematicHeroProps) {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      scrollTl
        .to(".bg-grid-theme", { scale: 1.2, opacity: 0.1, ease: "none", duration: 2 }, 0)
        .fromTo(".text-track", 
        ...
        .to({}, { duration: 2.5 })
        .to(".hero-text-wrapper", { autoAlpha: 0, duration: 0.5 }, "-=0.2")
        .to(".cta-wrapper", { autoAlpha: 1, duration: 0.5 }, "<") 
        .to({}, { duration: 1.5 })
            ...
            <div className="mockup-scroll-wrapper order-2 lg:order-2 relative w-full h-[380px] lg:h-[600px] flex items-center justify-center z-10" style={{ perspective: "1000px" }}>
              ...
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                ...
                >
                  ...
                  <div className="absolute inset-[7px] bg-[#00081a] rounded-[2.5rem] overflow-hidden shadow-[inset_0_0_15px_rgba(0,0,0,1)] text-white z-10">
                    ...
                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col">
                      <div className="phone-widget flex justify-between items-center mb-8">
                        <div className="flex flex-col">
                          ...
                          <span className="text-xl font-bold tracking-tight text-white drop-shadow-md">Active Alpha</span>
                        </div>
                        <div className="w-9 h-9 rounded-full bg-white/5 text-neutral-200 flex items-center justify-center font-bold text-sm border border-white/10 shadow-lg">BO</div>
                      </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="phone-widget widget-depth rounded-2xl p-3 flex items-center">
                          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-500/20 to-indigo-600/5 flex items-center justify-center mr-3 border border-indigo-400/20">
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  <div className="w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-gradient-to-b from-blue-500/20 to-blue-900/10 flex items-center justify-center border border-blue-400/30">
                    <span className="text-base lg:text-xl font-bold text-blue-400">15%</span>
                  </div>
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Return Target</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">Verified Strategy</p>
                  </div>
                </div>
                ...
                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  <div className="w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-gradient-to-b from-indigo-500/20 to-indigo-900/10 flex items-center justify-center border border-indigo-400/30">
                    <span className="text-base lg:text-lg text-indigo-400 font-bold">CA</span>
                  </div>
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Expert Governance</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">100% Audit Led</p>
                  </div>
                </div>
